...
const Header = ({
  ...
  return (
    <header className="border-b border-white/15 md:border-none fixed top-5 z-50 w-full border-2">
      <div className="flex justify-between items-center md:border border-white/15 md:p-2.5 rounded-xl mx-auto max-w-[900px] md:backdrop-blur p-5">
      ...
      {isDropdownVisible && <Dropdown onClose={closeDropdown} />}
    </header>
