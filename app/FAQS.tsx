      ...
      <div className="p-6 md:px-20">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-left">How to start ?</AccordionTrigger>
            <AccordionContent >
              You can start by contacting us at our-servies@gmail.com . We will get back to you within 24 hours.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger className="text-left">Can you redesign an existing website?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger className="text-left">Do you offer custom website designs or use templates?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className="text-left">Pricing ?</AccordionTrigger>
            <AccordionContent>
